...
class DbexpController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $dbexp->user_id = Auth::id();
        $dbexp->save();
        return redirect()->route('db_exp_index')->with('notification', 'El Expediente fue ACTUALIZADO correctamente.');
    }
    ...
    public function expediente(Request $request)
    {
        ...
        $year = date('y');
        $notification = 'El expediente fue INGRESADO correctamente. Nº de Expediente: ' . $nroexp->numero . '/' . $year;
