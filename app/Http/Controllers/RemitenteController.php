...
class RemitenteController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.remitentes.create')->with(compact('remitentes', 'localidads'));  // formulario remitente
    }
    ...
    public function edit($id)
    {
        ...
        $localidads = Localidad::all();
        return view('admin.remitentes.edit')->with(compact('remitente', 'localidads'));  // editar remitente    
    }
