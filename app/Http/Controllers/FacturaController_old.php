...
class FacturaController extends Controller
{
    ...
    public function generarPDF(Request $request)
    {
        ...
        foreach ($selectedNomencladors as $nomencladorId) {
            $cantidad = $request->input("nomenclador_cantidades.$nomencladorId");
            $nomencladorCantidades[$nomencladorId] = $cantidad;
            $subtotal = $cantidad * $nomencladorPrecios[$nomencladorId]; // Utilizar precio de nomenclador recuperado del formulario
            $nomencladorSubtotales[$nomencladorId] = $subtotal;
        }

        // Calcular las cantidades de ensayos
        foreach ($selectedEnsayos as $ensayoId) {
            $cantidad = $request->input("ensayo_cantidades.$ensayoId");
            $ensayoCantidades[$ensayoId] = $cantidad;
            $subtotal = $cantidad * $ensayoCostos[$ensayoId]; // Utilizar costo de ensayo recuperado del formulario
            $ensayoSubtotales[$ensayoId] = $subtotal;
        }
        ...
        $data = [
            ...
            'remitente' => $remitente,
            'selectedNomencladors' => $selectedNomencladors,
            'selectedEnsayos' => $selectedEnsayos,
