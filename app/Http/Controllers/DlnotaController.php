...
class DlnotaController extends Controller
{
    ...
    public function notapedido(Request $request)
    {
        if (Auth::user()->departamento_id == 1){
            ...
            $dlnota->user_id = $this->auth->user()->id;
            $dlnota->save(); // Insert nota
            $nronota = Dlnota::orderBy('numero', 'desc')->first();
            ...
            $nronota = Dbnota::orderBy('numero', 'desc')->first();
            ...
            $nronota = Dsbnota::orderBy('numero', 'desc')->first();
            ...
            $nronota = Dsonota::orderBy('numero', 'desc')->first();
            ...
            $nronota = Dsanota::orderBy('numero', 'desc')->first();
        } 
        $notification = 'La nota fué INGRESADA correctamente. Nº de Nota: '. $nronota->numero;
        return redirect('/dsa/pedidos/create')->with(compact('notification'));
    }
