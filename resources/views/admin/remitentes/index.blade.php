                            ...
                            @foreach ($remitentes as $remitente)
                                <tr>
                                    ...
                                    <td class="td-actions text-left">
                                        <a href="{{ url('/admin/remitentes/'.$remitente->id.'/edit')}}" title="Editar" rel="tooltip" class="btn btn-primary btn-round">
                                            <i class="fas fa-edit"></i>
                                        </a>       
                                        <a href="{{ url('/admin/remitentes/'.$remitente->id.'/delete')}}" onclick="
return confirm('¿Está seguro de eliminar el Remitente?')" title="Eliminar" rel="tooltip" class="btn btn-danger btn-round">
