@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'dsb.remitos.edit', 'title' => __('Sistema DPSA')])
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ url('/dsb/remitos/'.$dsb_remito->id.'/edit') }}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label for="remitente">Remitente:</label><br>
                                                    <select class="chosen-select" name="remitente">
                                                        ...
                                                        <option value="{{$remitente->id}}" @if(($dsb_remito->remitente_id) == ($remitente->id)) selected="selected" @endif>{{$remitente->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{$dsb_remito->fecha}}" class="form-control form-control-sm" id="datepicker" name="fecha">
                                        </div>
                                        </div>
                                        <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Nro de Nota:</label>
                                            <input type="text" class="form-control form-control-sm" name="nro_nota" value="{{$dsb_remito->nro_nota}}">
                                        </div>
                                        </div>
                                        <div class="col-md-2">
                                                <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="conclusion" value="{{ $dsb_remito->conclusion }}">
                                        </div>
                                        <a class="btn btn-default btn-close" href="{{ route('dsb_remitos_index') }}">Cancelar</a>
    ...
    <div class="modal-content">
      ...
      <h5 class="modal-title" id="myModalLabel">Agregar NºNota</h5>
        ...
        <form action="{{route('notaremito')}}" method="post">
          ...
          <input name="id" type="hidden" value="{{ $dsb_remito->id }}">
            <div class="form-group">
                <div class="form-group">
