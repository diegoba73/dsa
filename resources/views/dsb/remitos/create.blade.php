@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'dsb.remitos.create', 'title' => __('Sistema DPSA')])
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-group form-prevent-multiple-submit" method="post" action="{{ url('/dsb/remitos') }}">
                                    {{ csrf_field() }}           
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="conclusion">
                                        </div>
