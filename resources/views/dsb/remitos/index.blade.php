        ...
        <div class="container-fluid">
            <div class="header-body">
                ...
                <nav class="navbar navbar-left navbar navbar-dark" id="navbar-main">
                    ...
                    {{ Form::open(['route' => 'dsb_remitos_index', 'method' => 'GET', 'class' => 'form-inline pull-left']) }}
                    ...
                    <div class="form-group mr-1">
                            <button type="submit" class="btn btn-secondary btn-fab btn-fab-mini btn-round" href="{{ route('dsb_remitos_index') }}">
                ...
                <div class="card bg-gradient-default shadow">
                    <div class="card-header bg-gradient-default border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('dsb_remitos_create') }}" class="btn btn-sm btn-primary">Nueva Muestra</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-dark">
                            ...
                            <tbody>
                            @foreach ($dsb_remitos as $dsb_remito)
                                <tr>
                                    <td class="text-center">{{ $dsb_remito->nro_nota}}</td>
                        ...
                        {{ $dsb_remitos->appends(request()->except('page'))->links() }}
                        </ul>
                    </div>
                </div>
            </div>
