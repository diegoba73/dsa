...
@csrf
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Dirección Provincial de Salud Ambiental</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul style="background-color:#00d0ff" class="navbar-nav text-uppercase ml-auto rounded-lg">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#nomenclador">Nomenclador</a>
          </li>
          <li class="nav-item">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <h2>Secretaría de Salud - Provincia del Chubut</h2>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          ...
          <span class="fa-stack fa-4x">
            ...
            <div class="list-group pt-2">
            <a class="btn btn-primary btn-sm js-scroll-trigger" href="http://dsachubut.sytes.net/dsb/">Sitio Web</a>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          ...
          <span class="fa-stack fa-4x">
            ...
            <div class="list-group pt-2">
            <a class="btn btn-primary btn-sm js-scroll-trigger" href="http://dsachubut.sytes.net/db/">Sitio Web</a>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          ...
          <span class="fa-stack fa-4x">
            ...
            <div class="list-group pt-2">
            <a class="btn btn-primary btn-sm js-scroll-trigger" href="http://dsachubut.sytes.net/dso/">Sitio Web</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="bg-light page-section mt-0" id="portfolio">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">El Laboratorio Provincial de la Dirección Provincial de Salud Ambiental está constituido por 5 áreas de ensayos, las cuales brindan un servicio de calidad analítica siguiendo los estándares mundiales de las Normas ISO. Éstas áreas son:</h3>
        </div>
      </div>
      <div class="row">
    ...
    <!-- Nomenclador -->
    <section class="bg-light page-section" id="nomenclador">
    <div class="container">
          <div class="row">
            <div class="col-lg-12 mx-auto">
              <div class="modal-body">
                <!-- Project Details Go Here -->
                <h2 class="text-uppercase">Nomenclador</h2>
                <p class="item-intro text-muted">Valores de los Servicios prestados por los Departamentos Bromatología (DB), Saneamiento Básico(DSB), Salud Ocupacional(DSO).</p>
                <table class="table table-striped">
                  ...
                  @foreach ($nomencladors as $nomenclador)
                      <tr>
                          <td>{{ $nomenclador->id}}</td>
                          <td>{{ $nomenclador->descripcion}}</td>
                          <td>{{ $nomenclador->valor}}</td>
                          <td>{{ $nomenclador->departamento}}</td>
                      </tr>
                  @endforeach
                  </tbody>
                </table>
