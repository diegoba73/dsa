...
<html>
    ...
    <body>
        <header>
            <div id="logo">
                <img src="{{ asset('argon/img/brand/logo.png') }}" alt="Lab" id="imagen">
            </div>
            <div class="encabezado">
               
                    <h1>Stock Reactivos</h1>
        ...
        <section>
            <div>
                ...
                <table>
                <td style="width:765px" bgcolor="#2183E3"align="center"><font color="#fff"><strong>Datos Reactivo</strong></td>
                </table>
                <table id="tabla">
                ...
                <table>
                <td style="width:765px" bgcolor="#2183E3"align="center"><font color="#fff"><strong>Stock</strong></td>
                </table>
            </div>
        </section>
        <section>
            ...
            <hr/>
                <table id="tablaStock">
                    ...
                    @foreach ($stockreactivos as $stockreactivo)
                        <tr>
                            <td>{{$stockreactivo->fecha_apertura}}</td>
                            <td>{{$stockreactivo->fecha_entrada}}</td>
                            <td>{{$stockreactivo->fecha_vencimiento}}</td>
                            <td>{{$stockreactivo->fecha_baja}}</td>
                            <td>{{$stockreactivo->contenido}}</td>
                            <td>{{$stockreactivo->marca}}</td>
                            <td>{{$stockreactivo->lote}}</td>
