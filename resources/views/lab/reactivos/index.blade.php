                        ...
                        <table class="table table-striped align-items-center table-dark">
                            ...
                            @foreach ($reactivos as $reactivo)
                                                <tr>
                                                    ...
                                                    <td style="width:5px; text-align:center;"><i class="fas fa-check-circle fa-2x text-green"></i></td>
                                                    @else
                                                    <td style="width:5px; text-align:center;"><i class="fas fa-times-circle fa-2x text-red"></i></td>
                                                    @endif
                                                    <td style="width:50px">
                                                    ...
                                                    <td class="td-actions text-left">
                                                        <a href="{{ url('/lab/reactivos/'.$reactivo->id.'/edit')}}" title="Editar" rel="tooltip" class="btn btn-primary btn-round">
                                                            <i class="fas fa-edit"></i>
                                                        </a>  
                                                        <a href="{{ route('reactivo_stock', $reactivo->id) }}" title="Stock" rel="tooltip" class="btn btn-info btn-round">
