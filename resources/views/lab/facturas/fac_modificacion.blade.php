...
<html>
    ...
    <body>
            ...
            <table id="tabla">
                <tbody>
                    <tr>
                        ...
                        <td><strong>Fecha de vencimiento: </strong>{{ date("d/m/Y", strtotime($factura->fecha_vencimiento)) }}</td>
                    </tr>
                </tbody>
            </table>
            <table id="tabla_titulo">
                <tr>
                    <th class="titulo" style="width:765px" align="center"><strong>Detalle</strong></th>
                </tr>
            </table>
        </section>
        ...
        <footer class="pie">
            <p><b>Berwyn 226, Trelew - Chubut, Argentina - Teléfono:(+54) 280 4427421/4421011</b></p>
        </footer>
    </body>
    <br>
    <br>
