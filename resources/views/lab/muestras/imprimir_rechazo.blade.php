    ...
    <body>
        ...
        <footer class="pie">
            ...
            <div class="bottom-footer">
                <p><b>Los datos consignados se refieren exclusivamente a la muestra recibida y el Laboratorio declina toda responsabilidad por el uso indebido que se hiciere de éste informe. El presente certificado solo puede ser reproducido integramente y con autorización escrita del Laboratorio</b></p>
            <ul class="footer-nav">
                <li>
