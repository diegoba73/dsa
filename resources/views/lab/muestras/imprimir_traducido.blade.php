...
<head>
    ...
    <body>
            ...
            <hr/>
                <table id="tablaEnsayo">
                    ...
                    @foreach ($muestra->ensayos as $ensayo)
                        <tr>
                            <td style="width:400px;">{{ isset($ensayo) ? app('App\Http\Controllers\TraductorController')->traducir($ensayo->ensayo, 'en') : '' }}</td>
                            <td style="width:150px;">{{$ensayo->norma_procedimiento}}</td>
                            <td align="center">{{ isset($ensayo->pivot) ? app('App\Http\Controllers\TraductorController')->traducir($ensayo->pivot->resultado, 'en') : '' }}</td>
        ...
        <div><strong>Observations: </strong>{{ app('App\Http\Controllers\TraductorController')->traducir($muestra->observaciones, 'en') }}</div>
        <footer class="pie">
