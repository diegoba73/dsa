                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="entrada">Entrada:</label>
                                                            <p>
                                                            {!!Form::select('entrada', array('DECOMISO' => 'DECOMISO','CONTROL' => 'CONTROL','INTERVENCION' => 'INTERVENCION','DENUNCIA' => 'DENUNCIA','LICITACION' => 'LICITACION','INTOXICACION' => 'INTOXICACION','MUESTREO PROGRAMADO' => 'MUESTREO PROGRAMADO'), $muestra->entrada, ['class' => 'chosen-select'])!!}
                                                            </p>
                                                </div> 
                                            </div>
                                            <div class="col">
