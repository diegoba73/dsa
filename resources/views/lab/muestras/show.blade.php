                                                ...
                                                <div class="col-md-16">
                                                    ...
                                                    <div class="form-group ml-4">
                                                        <table>
                                                            ...
                                                            <tbody>
                                                            @foreach($muestra->ensayos->filter(function($ensayo) {
                                                                return Auth::user()->role_id != 4 || $ensayo->tipo_ensayo === 'Físico/Químico';
                                                            }) as $ensayo)
                                                            <tr>
                                        ...
                                        <div class="row">
                                            ...
                                            @if (($muestra->revisada === null) || ($muestra->revisada === 0))
                                                ...
                                                @if ((Auth::user()->departamento_id == 1) && ($muestra->cargada == 1))
                                                    <a class="btn btn-success btn-close" href="{{ url('/lab/muestras/'.$muestra->id.'/imprimir_resultado')}}" target="_blank">Imp. Resultado</a> 
                                                @endif
                                            ...
                                            @elseif (($muestra->revisada === 1) && ((Auth::user()->departamento_id == 1) && (Auth::user()->role_id == 1)))
                                                ...
                                                <a class="btn btn-success btn-close" href="{{ url('/lab/muestras/'.$muestra->id.'/imprimir_resultado')}}" target="_blank">Imp. Resultado</a> 
                                                <a class="btn btn-primary btn-close" href="{{ url('/lab/muestras/'.$muestra->id.'/imprimir_resultado_firma')}}" target="_blank">Imp. Resultado Firmado</a>
                                            @elseif (($muestra->revisada === 1) && (Auth::user()->departamento_id == 1))
                                                <a class="btn btn-success btn-close" href="{{ url('/lab/muestras/'.$muestra->id.'/imprimir_resultado')}}" target="_blank">Imp. Resultado</a>                                         
                                                <a class="btn btn-primary btn-close" href="{{ url('/lab/muestras/'.$muestra->id.'/imprimir_resultado_firma')}}" target="_blank">Imp. Resultado Firmado</a>
                                                <a class="btn btn-primary btn-close" href="{{ url('/lab/muestras/'.$muestra->id.'/imprimir_traducido')}}" target="_blank">Imp. Resultado Traducido</a>
                                            ...
                                            @if (Auth::user()->role_id == 1)
                                                    @if (($muestra->aceptada === 0))
                                                    <a class="btn btn-danger btn-close" href="{{ url('/lab/muestras/'.$muestra->id.'/imprimir_rechazo')}}" target="_blank">Imp. rechazo</a>
                                                    @endif
                                            @endif
                                            @if (
                                                ...
                                                <a class="btn btn-outline-success" href="{{ route('traducir', $muestra->id) }}">Traducir</a>
                                            @endif
