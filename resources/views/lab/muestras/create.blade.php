                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="entrada">Entrada:</label>
                                                            <p>
                                                            {!!Form::select('entrada',[null=>'Seleccionar Entrada'] + array('DECOMISO' => 'DECOMISO','CONTROL' => 'CONTROL','INTERVENCION' => 'INTERVENCION','PARTICULAR' => 'PARTICULAR','INSCRIPCION' => 'INSCRIPCION','SECUESTRO PREVENTIVO' => 'SECUESTRO PREVENTIVO','DENUNCIA' => 'DENUNCIA','DONACION' => 'DONACION','LICITACION' => 'LICITACION','INTOXICACION' => 'INTOXICACION','TRIQUINOSIS' => 'TRIQUINOSIS','MUESTREO PROGRAMADO' => 'MUESTREO PROGRAMADO','MAREA ROJA' => 'MAREA ROJA'), null, ['class' => 'chosen-select'])!!}
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="tipo_prestacion">Tipo de Prestación:</label>
                                                            <p>
                                                            {!!Form::select('tipo_prestacion',[null=>'Seleccionar Prestación'] +  array('APS' => 'APS','CONVENIO' => 'CONVENIO','ARANCELADO' => 'ARANCELADO','CALIDAD' => 'CALIDAD', 'CONTROL INTERNO' => 'CONTROL INTERNO'), null, ['class' => 'chosen-select'])!!}
