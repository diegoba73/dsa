                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="entrada">Entrada:</label>
                                                            <p>
                                                            {!!Form::select('entrada', array('DECOMISO' => 'DECOMISO','CONTROL' => 'CONTROL','INTERVENCION' => 'INTERVENCION','PARTICULAR' => 'PARTICULAR','INSCRIPCION' => 'INSCRIPCION','SECUESTRO PREVENTIVO' => 'SECUESTRO PREVENTIVO','DENUNCIA' => 'DENUNCIA','DONACION' => 'DONACION','LICITACION' => 'LICITACION','INTOXICACION' => 'INTOXICACION','TRIQUINOSIS' => 'TRIQUINOSIS','MUESTREO PROGRAMADO' => 'MUESTREO PROGRAMADO','MAREA ROJA' => 'MAREA ROJA'), $muestra->entrada, ['class' => 'chosen-select'])!!}
                                                            </p>
                                                </div> 
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="tipo_prestacion">Tipo de Prestación:</label>
                                                            <p>
                                                            {!!Form::select('tipo_prestacion', array('APS' => 'APS','CONVENIO' => 'CONVENIO','ARANCELADO' => 'ARANCELADO','CALIDAD' => 'CALIDAD'), $muestra->tipo_prestacion, ['class' => 'chosen-select'])!!}
                                                            </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <label for="remitente">Remitente:</label><br>
                                                        <select class="chosen-select" name="remitente">
                                                            ...
                                                            @foreach($remitentes as $remitente)
                                                            <option value="{{$remitente->id}}" @if(($muestra->remitente_id) == ($remitente->id)) selected="selected" @endif>{{$remitente->nombre}}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Condición:</label>
                                                            <p>
                                                            {!!Form::select('condicion', array('Sin/Conclusión' => 'Sin/Conclusión','Apto' => 'Apto','Apto Improcedente' => 'Apto Improcedente','No Apto' => 'No Apto','No Apto Físico/Químico' => 'No Apto Físico/Químico','No Apto Microbiológico' => 'No Apto Microbiológico','No Apto Fco./Qco. Y Micro.' => 'No Apto Fco./Qco. Y Micro.','No Apto Improcedente' => 'No Apto Improcedente','Improcedente Indeterminado' => 'Improcedente Indeterminado','Adulterado' => 'Adulterado','Falsificado' => 'Falsificado','Rechazada' => 'Rechazada'), $muestra->condicion, ['class' => 'form-control form-control-sm'])!!}
                                                            </p>
                                                </div>
                                            </div>
                                        </div>
