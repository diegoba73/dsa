                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-prevent-multiple-submit" method="post" action="{{ url('/lab/muestras/'.$muestra->id.'/edit') }}">
                                        ...
                                        <div class="row">
                                            @if (Auth::user()->id == 6 || Auth::user()->id == 30 || Auth::user()->id == 2 )
                                            <div class="col-6">
                                                <div class="form-group">
                                                <label for="departamento_id">Departamento:</label>
                                                            <p>
                                                            {!!Form::select('departamento_id',array('1' => 'DL', '2' => 'DB', '3' => 'DSB','4' => 'DSO'), $muestra->departamento_id, ['class' => 'chosen-select', 'style' => 'width: 70px;'])!!}
                                                            </p>
                                                </div>
                                            </div>
                                            @else
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <select class="chosen-select form-control @error('solicitante') is-invalid @enderror" name="solicitante">
                                                        <option value="" disabled {{ old('solicitante', $muestra->solicitante ?? '') == '' ? 'selected' : '' }}>
                                                            Seleccionar Solicitante
                                                        </option>
                                                        @foreach($remitentes as $remitenteOption)
                                                            <option value="{{ $remitenteOption->nombre }}"
                                                                {{ old('solicitante', $muestra->solicitante ?? '') == $remitenteOption->nombre ? 'selected' : '' }}>
                                                                {{ $remitenteOption->nombre }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error('solicitante')
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <select class="chosen-select form-control @error('remitente') is-invalid @enderror" name="remitente" id="remitente">
                                                        <option value="" disabled {{ old('remitente', $muestra->remitente_id ?? '') == '' ? 'selected' : '' }}>
                                                            Seleccionar Remitente
                                                        </option>
                                                        @foreach($remitentes as $remitenteOption)
                                                            <option value="{{ $remitenteOption->id }}"
                                                                {{ old('remitente', $muestra->remitente_id ?? '') == $remitenteOption->id ? 'selected' : '' }}>
                                                                {{ $remitenteOption->nombre }}
                                                            </option>
                                                        @endforeach
                                                    </select>
