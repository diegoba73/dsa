            ...
            <div>  
                ...
                <table id="tabla">
                    <tbody>
                        ...
                        <tr>
                            <td><strong>Fecha de Entrada: </strong>{{ date("d/m/Y", strtotime($muestra->fecha_entrada)) }}</td>
                            <td><strong>Fecha de Extracción: </strong>{{ date("d/m/Y", strtotime($muestra->fecha_extraccion)) }} <strong>Hora Extracción: </strong>{{$muestra->hora_extraccion}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><strong>Reg. Establecimiento: </strong>{{$muestra->registro_establecimiento}} | <strong>Reg. Producto: </strong>{{$muestra->registro_producto}}</td>
                        </tr>
                        <tr>
                            <td colspan="2"><strong>Lote: </strong>{{$muestra->lote}}</td>
                        </tr>
                        <tr>
