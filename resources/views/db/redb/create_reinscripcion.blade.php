                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="alert alert-default">
                                    <strong class="card-title">Reinscripcion de Registro R.E.D.B. {{$redb->establecimiento}}</strong>
                                </div>
                                <div class="card-body">
                                       ...
                                       @if (!empty($tramite->dbexp) && !empty($tramite->dbexp->numero))
                                        ...
                                        @endif
                                        <form id="formulario" method="post" action="{{ route('db_redb_store_reinscripcion', $redb->id) }}" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6 col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="chosen-select form-control" name="localidad_id" id="localidad">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="nuevaDevolucion">Observación:</label><br>
                                                <textarea id="nuevaDevolucion" name="observaciones" rows="4" cols="250" class="w-100" value="">Se solicita la reinscripción del Establecimiento.</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        @if (Auth::user()->role_id == 15)
                                            <button type="submit" class="btn btn-warning pull-center button-prevent-multiple-submit" name="submitType" value="reinscripcion">
...
function validarFormulario(event) {
    ...
    var pago = document.getElementById('pago'); // Nuevo campo para archivo de pago
    ...
    // Verificar si se ha adjuntado el archivo de pago
/*     if (!pago || pago.files.length === 0) {
