                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="alert alert-default">
                                    <strong class="card-title">Registro R.E.D.B. {{$redb->establecimiento}} / Nro Registro: {{$redb->numero}}</strong>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="{{ route('db_redb_update_inscripcion', $redb->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="expediente" value="{{ $redb->expediente}}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-group">
                                                <label class="bmd-label-floating">Razón:</label>
                                                <input type="text" class="form-control form-control-sm" name="establecimiento" value="{{ $redb->establecimiento }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="domicilio" value="{{ $redb->localidad->localidad }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="rubros">
                                        ...
                                        @elseif($tramite && Str::contains($tramite->tipo_tramite, 'MODIFICACION') && $tramite->estado == 'INICIADO')
                                            <!-- Banner de establecimiento en modificación y a la espera de aceptación -->
                                            <div class="alert alert-warning">
                                                <strong>EL ESTABLECIMIENTO ESTÁ MODIFICADO Y A LA ESPERA DE ACEPTACIÓN</strong>
                                            </div>
                                        @else
                                            <!-- Solo se muestra este contenido si el establecimiento NO está de baja y NO está en modificación -->
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                @if($redb->ruta_vinculacion)
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label for="vinculaciondt">NOTA VINCULACION DT:</label>
                                                            <div id="verVINCDT"></div>
                                                            <a href="{{ route('verVINCDT', $redb->id) }}" target="_blank">
                                                                Ver Archivo Guardado en Base de Datos
                                                            </a>
                                                        </div>
                                                    </div>
                                                @endif
