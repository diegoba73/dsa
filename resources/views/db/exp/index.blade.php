                ...
                <div class="card bg-gradient-default shadow">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-dark">
                            ...
                            <tbody>
                            @foreach ($dbexps as $dbexp)
                                <tr>
                                    <td class="text-center">{{ $dbexp->numero }} / {{ date('y', strtotime($dbexp->fecha)) }}</td>
                                    <td>{{ date('d-m-Y', strtotime($dbexp->fecha)) }}</td>
                                    <td>{{ $dbexp->descripcion}}</td>
                                    <td>{{ $dbexp->user->usuario}}</td>
                                    <td class="td-actions text-left">
                                        <a href="{{ url('/db/exp/'.$dbexp->id.'/edit')}}" title="Editar" rel="tooltip" class="btn btn-primary btn-round">
                        ...
                        {{ $dbexps->appends(request()->except('page'))->links() }}
                        </ul>
                    </div>
                </div>
            </div>
