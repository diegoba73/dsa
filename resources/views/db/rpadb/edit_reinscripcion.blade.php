...
@php
    ...
    if (Auth::user()->role_id === 15 && in_array($tramite->estado, ['INICIADO', 'DEVUELTO'])) {
    ...
    // ADMIN: puede agregar observaciones si va a devolver o modificar
                                ...
                                <form action="{{ route('rpadb.update_modificacion', ['id' => $rpadb->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card mt-4">
                                        ...
                                        @if ($tramite)
                                            ...
                                            @endforelse
                                        @else
                                            <p class="text-muted">Todavía no hay un trámite iniciado.</p>
                                        @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center mt-4">
                                        ...
                                        @if ($tramite && Auth::user()->role_id === 15 && in_array($tramite->estado, ['INICIADO', 'DEVUELTO']))
                                        ...
                                        @if (Auth::user()->role_id === 1 && $tramite->estado === 'APROBADO')
                                            ...
                                            <button type="submit" class="btn btn-success" onclick="setSubmitType('modificar')">Modificar Producto</button>
                                        @endif
                                    </div>
                                </form>
                            </div>
