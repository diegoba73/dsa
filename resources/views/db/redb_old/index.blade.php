                        ...
                        <table class="table table-striped align-items-center table-dark">
                            ...
                            @foreach ($redbs as $redb) 
                                <tr>
                                    ...
                                    <td style="width: 130px"><a class="text-white" href="{{ url('/redb/'.$redb->id.'/show')}}"><strong>{{ str_limit($redb->establecimiento, 20)}}</strong></a>
                                    </td>
                                    ...
                                    <td style="width:20px">
                                            @if ($redb->baja && $redb->baja->fecha_baja)
                                            <span class="badge badge-pill badge-danger">BAJA: {{ date('d-m-Y', strtotime($redb->baja->fecha_baja)) }}</span>
                                            @else
                                    ...
                                    <td class="td-actions text-left">
                                        ...
                                        @if (Auth::user()->role_id == 9 && !($redb->baja && $redb->baja->fecha_baja))
                                        <a href="{{ route('db_baja_create', ['redb_id' => $redb->id]) }}" title="Baja" rel="tooltip" class="btn btn-danger btn-round btn-sm">
                                            <i class="fas fa-trash"></i>
                                        </a>        
                                        @endif
                                        @if (!(Auth::user()->departamento_id == 2 && Auth::user()->role_id == 1))
                                        <a href="{{ route('db_redb_edit', ['redb_id' => $redb->id]) }}" title="Editar" rel="tooltip" class="btn btn-success btn-round btn-sm">
