        ...
        <div class="container-fluid">
            <div class="header-body">
                ...
                <nav class="navbar navbar-left navbar navbar-dark" id="navbar-main">
                    ...
                    {{ Form::open(['route' => 'db_archivo_index', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                    <div class="form-group mr-5">
                        <div class="input-group input-group-alternative">
                            <div class="input-group-prepend">
                                <span class="form-control form-control-sm"><i class="fas fa-search"></i></span>
                            </div>
                            {{ Form::text('caja', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Caja']) }}
                        </div>
                    </div>
                    <div class="form-group mr-5">
                        <div class="input-group input-group-alternative">
                    ...
                    <div class="form-group mr-1">
                            <button type="submit" class="btn btn-secondary btn-fab btn-fab-mini btn-round" href="{{ route('db_archivo_index') }}">
                ...
                <div class="card bg-gradient-default shadow">
                    <div class="card-header bg-gradient-default border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('db_archivo_create') }}" class="btn btn-sm btn-primary">Nuevo Archivo</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-dark">
                            ...
                            <tbody>
                            @foreach ($dbarchivos as $dbarchivo)
                                <tr>
                                    <td class="text-center">{{ $dbarchivo->caja }}</td>
                                    <td>{{ $dbarchivo->establecimiento }}</td>
                                    <td>{{ $dbarchivo->descripcion}}</td>
                                    <td>{{ $dbarchivo->user->usuario}}</td>
                                    <td class="td-actions text-left">
                                        <a href="{{ url('/db/archivo/'.$dbarchivo->id.'/edit')}}" title="Editar" rel="tooltip" class="btn btn-primary btn-round">
                        ...
                        {{ $dbarchivos->appends(request()->except('page'))->links() }}
                        </ul>
                    </div>
                </div>
            </div>
