                                ...
                                <tr>
                                    <td class="text-center">{{ $db_remito->nro_nota}}</td>
                                                    ...
                                                    <td class="td-actions text-left">
                                                        <a href="{{ url('/remitos/'.$db_remito->id.'/edit')}}" title="Editar" rel="tooltip" class="btn btn-primary btn-round">
                                                        <i class="fas fa-edit"></i>
                                                        </a>  
                                                        <a href="{{ url('/remitos/'.$db_remito->id.'/imprimir_remito')}}" target="_blank" title="Imprimir Remito" rel="tooltip" class="btn btn-primary btn-round">
                                                        <i class="fas fa-print"></i>
                                                            </a>
                                                        @if ($db_remito->chequeado === 1)
                                                        <a href="{{ url('/remitos/'.$db_remito->id.'/imprimir_remito_firma')}}" target="_blank" title="Imprimir Remito con firma" rel="tooltip" class="btn btn-primary btn-round">
