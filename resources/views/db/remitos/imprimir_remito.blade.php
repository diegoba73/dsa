...
<html>
    ...
    <body>
        <header>
            ...
            <table id="tabla">
                <tr>
                <td style="width:250px"><strong>{{$db_remito->remitente->nombre}}</strong></td>
                </tr>
                <tr>
                <td style="width:250px"><strong>{{$db_remito->remitente->contacto}}</strong></td>
                </tr>
                <tr>
                <td style="width:250px"><strong>{{$db_remito->remitente->direccion}}</strong></td>
                </tr>
                <tr>
                <td style="width:250px"><strong>{{$db_remito->remitente->localidad->localidad}} / {{$db_remito->remitente->localidad->provincia->provincia}}</strong></td>
                </tr>
                <tr>
        ...
        <section>
            ...
            <br>
            <br>
            <p>Nº de Nota: {{$db_remito->nro_nota}}/D.B.</p>
            </div>
            </div>
        </section>
    </body>
