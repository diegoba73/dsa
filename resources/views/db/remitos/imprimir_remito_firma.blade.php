    ...
    <body>
        <header>
            ...
            <table id="tabla">
                ...
                <tr>
                <td><strong>{{$db_remito->remitente->localidad->localidad}} / {{$db_remito->remitente->localidad->provincia->provincia}}</strong></td>
                </tr>
                <tr>
        ...
        <section>
            ...
            <div>               
                ...
                <table>
                <tr>
                <td></td><td><img src="{{ asset('argon/img/brand/firma_db.jpg') }}" alt="Firma" width="800" height="250"></td>
                </tr>
                </table>
            </div>
            <div class="row">
            ...
            <br>
            <br>
            <p>Nº de Nota: {{$db_remito->nro_nota}}/D.S.B.</p>
            </div>
            </div>
        </section>
    </body>
