@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'db.remitos.create', 'title' => __('Sistema DPSA')])
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-group form-prevent-multiple-submit" method="post" action="{{ url('/db/remitos') }}">
                                    {{ csrf_field() }}                                   
