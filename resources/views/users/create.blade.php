                        ...
                        <form method="post" action="{{ route('user.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('usuario') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="usuario" id="input-usuario" class="form-control form-control-alternative{{ $errors->has('usuario') ? ' is-invalid' : '' }}" placeholder="{{ __('Usuario') }}" value="" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('role_id') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="role_id" id="input-role_id" class="form-control form-control-alternative{{ $errors->has('role_id') ? ' is-invalid' : '' }}" placeholder="{{ __('Rol') }}" value="" required>
                                ...
                                <div class="form-group{{ $errors->has('departamento_id') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="departamento_id" id="input-departamento_id" class="form-control form-control-alternative{{ $errors->has('departamento_id') ? ' is-invalid' : '' }}" placeholder="{{ __('Departamento') }}" value="" required>
                                ...
                                <div class="form-group{{ $errors->has('activo') ? ' has-danger' : '' }}">
                                    ...
                                    {!! Form::checkbox('activo', true, NULL) !!}
