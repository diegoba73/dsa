        ...
        <div class="container-fluid">
            <div class="header-body">
                ...
                <nav class="navbar navbar-left navbar navbar-dark" id="navbar-main">
                    ...
                    <div class="form-group mr-1">
                            <button type="submit" class="btn btn-secondary btn-fab btn-fab-mini btn-round" href="{{ route('dso_remitos_index') }}">
                            ...
                            @foreach ($dso_remitos as $dso_remito)
                                <tr>
                                    <td class="text-center">{{ $dso_remito->nro_nota}}</td>
                                                    ...
                                                    <td>{{ $dso_remito->remitente->nombre}}</td>
                                                    <td>{{ $dso_remito->conclusion}}</td>
                                                    @if (strtotime($dso_remito->fecha_salida) > 0)
