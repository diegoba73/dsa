                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-group form-prevent-multiple-submit" method="post" action="{{ url('/dsa/facturas') }}">
                                    {{ csrf_field() }}
                                    <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="datepicker" name="fecha_pago">
                                        </div>
                                    </div>
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Depositante:</label>
                                            <input type="text" class="form-control" name="depositante">
                                        </div>
                                        <div class="form-group">
