                                    ...
                                    {{ csrf_field() }}
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="label-control">Fecha de pedido:</label>
                                                     <input type="date" class="form-control form-control-sm" id="datepicker" name="fecha_pedido" value="<?php echo date('Y-m-d'); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="pasado_a">
                                            </div>
                                            <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label class="label-control">Fecha de pase:</label>
                                                        <input type="date" class="form-control form-control-sm" id="datepicker" name="fecha_pase">
                                                    </div>
                                            </div>
                                        </div>
...
$(document).ready(function(){
 ...
 $(document).on('click', '.addI', function(){
    ...
    html += '<td><select class="chosen-select" name="insumo[]">@foreach($insumos as $insumo)<option value="{{$insumo->id}}">{{$insumo->nombre}} / {{$insumo->descripcion}}</option>@endforeach</select></td>';
