...
class Pedido extends Model
{
    ...
    {
        return $this->belongsToMany(Reactivo::class)->withPivot('cantidad_pedida', 'cantidad_entregada', 'costo_total', 'observaciones');
    }

    public function insumos()
    {
        return $this->belongsToMany('App\Insumo')->withPivot('cantidad_pedida', 'cantidad_entregada', 'observaciones');
    }
