...
class AnuarioController extends Controller
{
    ...
    public function resultados(Request $request)
    {
        ...
        ->get();
        $muestrasMicrobiologia = $muestras->where('microbiologia', 1)->count();
        $muestrasQuimicaAlimentos = $muestras->whereIn('matriz_id', [1, 2])
                                                ->where('quimica', 1)->count();
        $muestrasQuimicaAgua = $muestras->whereIn('matriz_id', [3, 4, 5, 9, 10, 11, 12, 13, 14, 15])
                                        ->where('quimica', 1)->count();
        $muestrasEnsayoBiologico = $muestras->where('ensayo_biologico', 1)->count();
        $muestrasCromatografia = $muestras->where('cromatografia', 1)->count();
