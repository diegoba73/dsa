        ...
        <div class="container-fluid">
            <div class="header-body">
                ...
                <nav class="navbar navbar-left navbar navbar-dark" id="navbar-main">
                    ...
                    {{ Form::open(['route' => 'lab_notas_index', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                    ...
                    <div class="form-group mr-1">
                            <button type="submit" class="btn btn-secondary btn-fab btn-fab-mini btn-round" href="{{ route('lab_notas_index') }}">
            ...
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card bg-gradient-default shadow">
                    <div class="card-header bg-gradient-default border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('lab_notas_create') }}" class="btn btn-sm btn-primary">Nueva Nota</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        {{ $dlnotas->appends(request()->except('page'))->links() }}
                        </ul>
                    </div>
                </div>
            </div>
