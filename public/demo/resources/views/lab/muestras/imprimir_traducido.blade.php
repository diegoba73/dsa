            ...
            <div>  
                ...
                <table id="tabla">
                        ...
                        <tr>
                            ...
                            <td><strong>Establishment register nbr: </strong>{{$muestra->registro_establecimiento}}</td>
                            
                        </tr>
                        <tr>
                            <td><strong>Product register: </strong>{{$muestra->registro_producto}}</td>
                            <td><strong>Lot nbr: </strong>{{$muestra->lote}}</td>
                        </tr>
                        <tr>
