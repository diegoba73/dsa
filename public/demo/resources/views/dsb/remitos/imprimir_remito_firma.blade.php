...
<html>
    ...
    <body>
        <header>
            ...
            <table id="tabla">
                <tr>
                <td><strong>{{$dsb_remito->remitente->nombre}}</strong></td>
                </tr>
                <tr>
                <td><strong>{{$dsb_remito->remitente->contacto}}</strong></td>
                </tr>
                <tr>
                <td><strong>{{$dsb_remito->remitente->direccion}}</strong></td>
                </tr>
                <tr>
                <td><strong>{{$dsb_remito->remitente->localidad->localidad}} / {{$dsb_remito->remitente->localidad->provincia->provincia}}</strong></td>
                </tr>
                <tr>
        ...
        <section>
            <div>
                <table id="tablaEnsayo">
                    ...
                    <tbody>
                    @foreach ($dsb_remito->muestras as $muestra)
                        <tr>
            ...
            <div>               
                <table id="tabla">
                <tr>
                <td style="width:150px"> </td><td><strong>Conclusión: </strong><textarea name="conclusion" rows="10" cols="80" style="font-family:Arial, sans-serif; border: none;">{{$dsb_remito->conclusion}}</textarea></td>
                </tr>
                <tr>
                <tr>
                ...
                <table>
                <tr>
                <td style="width:250px"></td><td><img src="{{ asset('argon/img/brand/firma_dsb.jpg') }}" alt="Firma" id="imagen" width="400" height="250"></td>
                </tr>
                </table>
            </div>
            <div class="row">
            ...
            <br>
            <br>
            <p>Nº de Nota: {{$dsb_remito->nro_nota}}/D.S.B.</p>
            </div>
            </div>
        </section>
    </body>
