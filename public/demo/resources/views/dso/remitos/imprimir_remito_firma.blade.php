    ...
    <body>
        <header>
            ...
            <table id="tabla">
                ...
                <tr>
                <td style="width:150px"></td><td>Me dirijo a usted a fin de remitir adjunto el/los certificados de la/s siguientes muestras que se detallan a continuación:</td>
                </tr>
                </table>
        ...
        <section>
            ...
            <div>               
                ...
                <table>
                <tr>
                <td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{ asset('argon/img/brand/firma_dso.jpg') }}" alt="Firma" id="imagen" width="400" height="250"></td>
                </tr>
                </table>
            </div>
            <div class="row">
