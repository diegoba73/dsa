@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'db.archivo.create', 'title' => __('Sistema DPSA')])
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="alert alert-default">
                                    <strong class="card-title">Ingreso al Archivo</strong>
                                </div>
                                <div class="card-body">
                                    <form class="form-group form-prevent-multiple-submit" method="post" action="{{ url('/db/archivo') }}">
                                    {{ csrf_field() }}
                                    <div class="col-md-2">
