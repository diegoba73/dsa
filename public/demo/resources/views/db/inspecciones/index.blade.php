                ...
                <nav class="navbar navbar-left navbar navbar-dark" id="navbar-main">
                    ...
                    <div class="form-group mr-3">
                        <div class="input-group input-group-alternative">
                            ...
                            {{ Form::text('direccion', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Direccion']) }}
                        </div>
                    </div>               
            ...
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card bg-gradient-default shadow">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-dark">
                            ...
                            @foreach ($inspecciones as $inspeccion)
                                <tr>
                                    ...
                                    <td style="width:20px">{{ $inspeccion->razon}}</td>
                                    <td style="width:20px">{{ $inspeccion->direccion}}</td>
                                    ...
                                    <td class="td-actions text-left">
                                        ...
                                        data-srid="{{$inspeccion->id}}" data-srdetalle="{{$inspeccion->detalle}}" data-srfecha="{{$inspeccion->fecha}}" data-srrazon="{{$inspeccion->razon}}"data-target="#detalleModal{{$inspeccion->id}}">
                        ...
                        {{ $inspecciones->appends(request()->except('page'))->links() }}
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <input type="text" value= "INSPECCION DE:" readonly style="border: none;" style="text-align: right;"><input type="text" name="razon" id="razon" readonly style="text-align: left; border: none;">
                <br>
