@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'db.exp.create', 'title' => __('Sistema DPSA')])
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-group form-prevent-multiple-submit" method="post" action="{{ url('/db/exp') }}">
                                    {{ csrf_field() }}
                                    <div class="col-md-2">
